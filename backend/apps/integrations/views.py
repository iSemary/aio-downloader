...
from apps.integrations.telegram import get_owner_bot_token, send_job_to_telegram, test_connection
...
class TelegramPushView(APIView):
    def post(self, request, job_id):
        ...
        try:
            ...
            job.telegram_sent_at = timezone.now()
            job.save(update_fields=["sent_to_telegram", "telegram_sent_at", "updated_at"])
